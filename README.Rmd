...
This package is a template for creating your own custom color palette package. Having your own color palette package will make it easy for you (and your labmates, teammates, etc) to use a consistent color palette for the same identifiers in your data. For example, the Wolfe Lab at Tufts University has approximately a dozen members working with the same species of microbes. I wrote WolfeR to make it trivial for each lab member to use the same colors to refer to the same species. 

## Working with packages in R

To create your own package from this template, you'll need a few tools set up:

  - git and github [see Happy Git with R](https://happygitwithr.com/)
  - For windows: [Rtools](https://cran.r-project.org/bin/windows/Rtools/rtools42/rtools.html).
